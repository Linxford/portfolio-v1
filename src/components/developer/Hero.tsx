...
import {
    ArrowRight, Download, Github, Smartphone, Code2, Sparkles
} from 'lucide-react';
...
export default function Hero() {
    ...
    return (
        <section
            id="home"
            className="min-h-screen flex items-center pt-16 bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-800"
        >
